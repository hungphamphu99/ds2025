...
The system is organized using a client-server architecture. The server is responsible for managing connections and transferring files, while the client handles connection requests and receiving files.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{Screenshot 2024-11-24 at 18.10.13.png}
